...
public class ConsultasSeguimiento extends Conexion {
    ...
    String mifecha1="01/01/2000";
    String mifecha2="01/01/2000";
    ...
    public DefaultTableModel verDetalleSeguimiento(frmSeguimiento frmSeg, int tipoBusqueda){
        ...
        //formateadorFechaCorta.format(frmSeg.jftxtFechaDesde.getText());
        /*try{
        
        SimpleDateFormat fechaFormato= new SimpleDateFormat("dd/MM/yyyy");
            fechaD = fechaFormato.parse(frmSeg.jftxtFechaDesde.getText());
            fechaH=fechaFormato.parse(frmSeg.jftxtFechaHasta.getText());
            JOptionPane.showMessageDialog(null, fechaD+" - "+frmSeg.jftxtFechaDesde.getText());
        }catch(ParseException pe){
                System.out.println(pe);
                JOptionPane.showMessageDialog(null, fechaD+" - "+frmSeg.jftxtFechaDesde.getText()+" - "+ pe);
        }*/
        
        //modifica las fechas cargadas en las cajas de texto invirtiendo dias por Mes paraa daptar al formato Access
        CargaFechasDesdeTxt(frmSeg.jftxtFechaDesde.getText(),frmSeg.jftxtFechaHasta.getText());
       
   
        //JOptionPane.showMessageDialog(null,frmSeg.jftxtFechaDesde.getText().substring(2,2) + " - "+frmSeg.jftxtFechaDesde.getText().length()+" - "+ frmSeg.jftxtFechaHasta.getText().length() );
             //JOptionPane.showMessageDialog(null,mifecha1+"  "+mifecha2);
        ...
        String sql = "";
         try{
            ...
            switch (TipoBusqueda) {
                case 0://toda la grilla
                    sql = "SELECT seguimiento.id,seguimiento.fecha,seguimiento.dnialumno,alumno.nombre,seguimiento.motivo,seguimiento.detalle FROM seguimiento,alumno WHERE seguimiento.dnialumno=alumno.dni ORDER BY seguimiento.fecha";
                    break;
                case 1://nombre y fecha desde
                    sql = "SELECT seguimiento.id,seguimiento.fecha,seguimiento.dnialumno,alumno.nombre,seguimiento.motivo,seguimiento.detalle FROM seguimiento,alumno WHERE seguimiento.dnialumno=alumno.dni AND alumno.nombre = '" + frmSeg.jcbNombre.getSelectedItem() + "' AND seguimiento.fecha = #" + mifecha1 + "# ORDER BY seguimiento.fecha";
                    
                    break;

                case 2://nombre y fecha desde hasta 
                    sql = "SELECT seguimiento.id,seguimiento.fecha,seguimiento.dnialumno,alumno.nombre,seguimiento.motivo,seguimiento.detalle FROM seguimiento,alumno WHERE seguimiento.dnialumno=alumno.dni AND alumno.nombre LIKE '" + frmSeg.jcbNombre.getSelectedItem() + "' AND seguimiento.fecha >= #" + mifecha1 + "# AND seguimiento.fecha <= #" + mifecha2 + "# ORDER BY seguimiento.fecha";
                     break;
                case 3://dni y fecha desde
                    //sql="SELECT seguimiento.id,seguimiento.fecha,seguimiento.dnialumno,alumno.nombre,seguimiento.motivo,seguimiento.detalle FROM seguimiento,alumno WHERE seguimiento.dnialumno=alumno.dni AND alumno.dni =" + Integer.parseInt((String) frmSeg.jcbDni.getSelectedItem()) + " AND seguimiento.fecha = #" + frmSeg.jftxtFechaDesde.getText() + "# ORDER BY seguimiento.fecha";
                    sql="SELECT seguimiento.id, seguimiento.fecha, seguimiento.dnialumno, alumno.nombre, seguimiento.motivo, seguimiento.detalle FROM seguimiento, alumno WHERE seguimiento.dnialumno=alumno.dni AND alumno.dni ="+ frmSeg.jcbDni.getSelectedItem() +" AND (seguimiento.fecha >= #" + mifecha1 + "# ORDER BY seguimiento.fecha";
                   //JOptionPane.showMessageDialog(null, sql);
                    break;

                case 4://dni y fecha desde hasta
                    //sql = "SELECT seguimiento.id,seguimiento.fecha,seguimiento.dnialumno,alumno.nombre,seguimiento.motivo,seguimiento.detalle FROM seguimiento,alumno WHERE seguimiento.dnialumno=alumno.dni AND alumno.dni =" + Integer.parseInt((String) frmSeg.jcbDni.getSelectedItem()) + " AND seguimiento.fecha >= #" + frmSeg.jftxtFechaDesde.getText() + "# AND seguimiento.fecha <= #" + frmSeg.jftxtFechaDesde.getText() + "# ORDER BY seguimiento.fecha";
                    
                    sql="SELECT seguimiento.id, seguimiento.fecha, seguimiento.dnialumno, alumno.nombre, seguimiento.motivo, seguimiento.detalle FROM seguimiento, alumno WHERE seguimiento.dnialumno=alumno.dni AND alumno.dni ="+ frmSeg.jcbDni.getSelectedItem() +" AND seguimiento.fecha BETWEEN #" + mifecha1 + "# AND #" + mifecha2 + "# ORDER BY seguimiento.fecha";
                    //JOptionPane.showMessageDialog(null, sql);
                     break;

                case 5://nombre
                    sql = "SELECT seguimiento.id,seguimiento.fecha,seguimiento.dnialumno,alumno.nombre,seguimiento.motivo,seguimiento.detalle FROM seguimiento,alumno WHERE seguimiento.dnialumno=alumno.dni AND alumno.nombre LIKE '" + frmSeg.jcbNombre.getSelectedItem() + "' ORDER BY seguimiento.fecha";
                    break;

                case 6://dni
                    sql = "SELECT seguimiento.id,seguimiento.fecha,seguimiento.dnialumno,alumno.nombre,seguimiento.motivo,seguimiento.detalle FROM seguimiento,alumno WHERE seguimiento.dnialumno=alumno.dni AND alumno.dni LIKE '" + frmSeg.jcbDni.getSelectedItem() + "' ORDER BY seguimiento.fecha";
                    break;

                case 7://fecha desde
                    sql = "SELECT seguimiento.id,seguimiento.fecha,seguimiento.dnialumno,alumno.nombre,seguimiento.motivo,seguimiento.detalle FROM seguimiento,alumno WHERE seguimiento.dnialumno=alumno.dni AND seguimiento.fecha = #" + mifecha1 + "# ORDER BY seguimiento.fecha";
                    break;

                case 8://fecha desde hasta
                    
                    sql = "SELECT seguimiento.id,seguimiento.fecha,seguimiento.dnialumno,alumno.nombre,seguimiento.motivo,seguimiento.detalle FROM seguimiento,alumno WHERE seguimiento.dnialumno=alumno.dni AND seguimiento.fecha >= #" + mifecha1 + "# AND seguimiento.fecha <= #" + mifecha2 + "# ORDER BY seguimiento.fecha";
                    break;
            ...
            //JOptionPane.showMessageDialog(null, sql+" TipoBusqueda "+ TipoBusqueda);
            ...
            while (rsTabla.next()) {
                ...
                for (int i = 0; i < cantidadColumnas; i++) {
                    if(i==1){
                       //si la columno es Fecha
                       //Date fechaAcc= (Date) rsTabla.getObject(i + 1);
                        SimpleDateFormat fechaFormat = new SimpleDateFormat("dd/MM/YYYY");
                        String fechaTabla = fechaFormat.format(rsTabla.getObject(i + 1));                        
                        filas[i] = fechaTabla;
                    }else{
        ...
        switch (tipoReporte) {
            ...
            case 1://Busca por nombre de alumno y Fecha
                try {
                    ...
                    Map parametro=new HashMap();
                    parametro.put("parameter1", frmSeg.jcbNombre.getSelectedItem());
                    parametro.put("parameter2", mifecha1);
                    parametro.put("parameter3", mifecha1);
            ...
            case 2://Busca por Nombre de alumno y Fecha Desde Hasta
                try {
                    ...
                    parametro.put("parameter1", frmSeg.jcbNombre.getSelectedItem());
                    parametro.put("parameter2", mifecha1);
                    parametro.put("parameter3", mifecha2);
            ...
            case 7://Busca por Fecha
                try {
                    ...
                    Map parametro=new HashMap();
                    parametro.put("parameter1", mifecha1);
                    parametro.put("parameter2", mifecha1);
            ...
            case 8://Busca por Fecha Desde Hasta
                try {
                    ...
                    Map parametro=new HashMap();
                    parametro.put("parameter1", mifecha1);
                    parametro.put("parameter2", mifecha2);
...
//*************************CRUD REGISTRO DE SEGUIMIENTO *****************
        public boolean registrarSeguimiento(ModSeguimiento modSeg) {
            ...
            Connection con = getConexion();
            ResultSet rs=null;
            CargaFechasDesdeTxt(modSeg.fecha,modSeg.fecha);
            try {
                String sql = "INSERT INTO seguimiento (fecha,motivo,detalle,dnialumno,idprofesor)VALUES (#"+mifecha1+"#,?,?,?,?)";
                ps = con.prepareStatement(sql);
                
                //ps.setString(1, modSeg.fecha);
                ps.setString(1, modSeg.motivo);
                ps.setString(2, modSeg.detalle);
                ps.setInt(3, modSeg.dniAlumno);
                ps.setInt(4, modSeg.idprofesor);
                ps.execute();
    ...
    public boolean modificarSeguimiento(ModSeguimiento modSeg) {
        ...
        try {
            ...
            CargaFechasDesdeTxt(modSeg.fecha,modSeg.fecha);
            String sql = "UPDATE seguimiento SET fecha=#"+mifecha1+"#, motivo='"+modSeg.motivo+"',detalle='"+modSeg.detalle+"',dnialumno="+modSeg.dniAlumno+",idprofesor="+modSeg.idprofesor+" WHERE id="+ modSeg.id;
            //fecha=#"+modSeg.fecha+"#,
            ps = con.prepareStatement(sql);
            /*
            ps.setString(1, modSeg.fecha);
    ...
    public void cargaComboAlumnos(ModSeguimiento ModSeg, frmRegSeguimiento FrmRegSeg) {
        ...
        try {
            ...
            ps = con.prepareStatement(sql);
            rsAlumno = ps.executeQuery();

            frmRegSeg.jcbxAlumno.removeAllItems();
    ...
    public void cargaComboProfesores(ModSeguimiento ModSeg, frmRegSeguimiento FrmRegSeg) {
        ...
        try {
            ...
            ps = con.prepareStatement(sql);
            rsProf = ps.executeQuery();

            frmRegSeg.jcbxProfesor.removeAllItems();
    ...
    public void CargaFechasDesdeTxt(String fechaA, String fechaB){
        String fecha1;
        String fecha2;
        fecha1=fechaA;
        fecha2=fechaB;
        mifecha1 = fecha1.substring(3,5)+"/"+fecha1.substring(0,2)+"/"+ fecha1.substring(6,10);
        mifecha2=fecha2.substring(3,5)+"/"+fecha2.substring(0,2)+"/"+ fecha2.substring(6,10);
        
        /*if(frmSeg.jftxtFechaDesde.getText().length() == 10 && frmSeg.jftxtFechaHasta.getText().length() == 10){
            mifecha1 = frmSeg.jftxtFechaDesde.getText().substring(3,5)+"/"+frmSeg.jftxtFechaDesde.getText().substring(0,2)+"/"+ frmSeg.jftxtFechaDesde.getText().substring(6,10);
            mifecha2=frmSeg.jftxtFechaHasta.getText().substring(3,5)+"/"+frmSeg.jftxtFechaHasta.getText().substring(0,2)+"/"+ frmSeg.jftxtFechaHasta.getText().substring(6,10);
        }*/
    }
